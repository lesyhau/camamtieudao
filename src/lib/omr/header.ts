...
import type { Binary, Component, Rect, TextRegion } from "./types.ts";
import type { OcrBackend } from "./ocr.ts";
import { srcCanvasOf, mergeToChars, chunkCells, buildStrip } from "./lyrics.ts";
import { OffscreenCanvas } from "./canvas.ts";
