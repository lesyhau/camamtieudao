...
// The one section that matters more than the rest is 4, on copyright. This service reads sheet
...
export default function Page() {
  ...
  return (
    <LegalPage title="Điều khoản sử dụng" updated="08/08/2026">
      <p className="lede">
        Khi dùng Cảm âm Tiêu Dao, bạn đồng ý với những điều dưới đây. Chúng tôi viết ngắn và rõ
        nhất có thể, vì điều khoản dài mà không ai đọc thì chẳng bảo vệ được ai.
      </p>

      <h2>1. Dịch vụ này là gì</h2>
      <p>
      ...
      <h2>2. Kết quả chỉ mang tính tham khảo</h2>
      <p>
      ...
      <h2>3. Trách nhiệm khi tải ảnh lên</h2>
      ...
      <p>
        ...
        dùng, trong giới hạn quyền tác giả nói ở mục 4. Riêng tên gọi, logo, giao diện và mã
        nguồn của trang thì thuộc về Cảm âm Tiêu Dao.
      </p>

      <h2>6. Sử dụng hợp lý</h2>
      <p>
      ...
      <h2>9. Dịch vụ được cung cấp «như hiện có»</h2>
      <p>
      ...
      <p>
        ...
        sót. Mục 2 nói rõ vì sao bạn nên đối chiếu với bản gốc.
      </p>
      ...
      <h2>12. Luật áp dụng và liên hệ</h2>
      <p>
